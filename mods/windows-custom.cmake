if(NOT _VCPKG_WINDOWS_TOOLCHAIN)
    ...
    if(NOT (CMAKE_CXX_COMPILER MATCHES "clang-cl.exe"))
        ...
        set(VCPKG_C_FLAGS_RELEASE "${VCPKG_C_FLAGS_RELEASE} /GL ")
        set(VCPKG_CXX_FLAGS_RELEASE "${VCPKG_CXX_FLAGS_RELEASE} /GL ")
        set(VCPKG_LINKER_FLAGS_RELEASE "${VCPKG_LINKER_FLAGS_RELEASE} /LTCG:INCREMENTAL ")
    else()
        set(VCPKG_C_FLAGS_RELEASE "${VCPKG_C_FLAGS_RELEASE} -flto=thin ")
        set(VCPKG_CXX_FLAGS_RELEASE "${VCPKG_CXX_FLAGS_RELEASE} -flto=thin ")
    endif()
